<template>
  <q-page class="q-pa-md flex flex-center">
    <div class="inv-card q-pa-lg" style="max-width: 420px; width: 100%;">
      <div class="text-h5 inv-section-title q-mb-md">Entrar no Involvest</div>
      <q-form @submit.prevent="onSubmit" class="q-gutter-md">
        ...
        <q-btn label="Entrar" color="primary" type="submit" class="full-width" />
        <q-btn flat label="Criar conta" @click="goRegister" class="full-width" />
      </q-form>
